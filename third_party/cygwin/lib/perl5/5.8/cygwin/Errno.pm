...
"cygwin-thread-multi-64int-1.5.18(0.13242)" or
	die "Errno architecture (cygwin-thread-multi-64int-1.5.18(0.13242)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
