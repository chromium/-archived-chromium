...
//Our toString on functions includes some of the native code. Exclude this test.
//var sinStr = '\nfunction sin() {\n    [native code]\n}\n'
//shouldBe("String(Math.sin)", "sinStr");
shouldBe("typeof Math.sin", "'function'");
...
// Removing this test because it's not valid javascript.
// Neither FF or Chrome support this.
