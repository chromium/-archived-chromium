...
bool ContainerNode::removeChildren()
{
    ...
    // FORK: http://b/960446, https://bugs.webkit.org/show_bug.cgi?id=18803
    // We store n in a RefPtr, since willRemoveChild could cause an event
    // to be dispatched which could re-enter this function and destroy our
    // child nodes out from underneath us.
