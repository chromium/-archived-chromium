...
bool Node::isDefaultNamespace(const String &namespaceURI) const
{
    ...
    switch (nodeType()) {
        ...
        case DOCUMENT_NODE:
            {
            Element* e = static_cast<const Document *>(this)->documentElement();
            return e ? e->isDefaultNamespace(namespaceURI) : false;
            }
        case ENTITY_NODE:
        case NOTATION_NODE:
...
String Node::lookupPrefix(const String &namespaceURI) const
{
    ...
    switch (nodeType()) {
        ...
        case DOCUMENT_NODE:
            {
            Element* e = static_cast<const Document *>(this)->documentElement();
            return e ? e->lookupPrefix(namespaceURI) : String();
            }
        case ENTITY_NODE:
        case NOTATION_NODE:
        case DOCUMENT_FRAGMENT_NODE:
...
String Node::lookupNamespaceURI(const String &prefix) const
{
    ...
    switch (nodeType()) {
        ...
        case DOCUMENT_NODE:
            {
            Element* e = static_cast<const Document *>(this)->documentElement();
            return e ? e->lookupNamespaceURI(prefix) : String();
            }
        case ENTITY_NODE:
        case NOTATION_NODE:
        case DOCUMENT_TYPE_NODE:
