...
# jhaas: there doesn't seem to be any harm in leaving these in
...
sub GenerateFunctionCallString()
{
  ...
  my $returnsPodType = $codeGenerator->IsPodType($returnType);
...
sub GenerateSVGContextRetrieval
{
  ...
  my $srcIsPodType = $codeGenerator->IsPodType($srcType);
