    ...
    if (!initialized) {
      static const int kFramePartBitmapIds[] = {
        ...
        IDR_VIEWS_APP_TOP_LEFT, IDR_VIEWS_APP_TOP_CENTER, IDR_VIEWS_APP_TOP_RIGHT,
            IDR_VIEWS_CONTENT_RIGHT_SIDE, IDR_VIEWS_CONTENT_BOTTOM_RIGHT_CORNER,
            IDR_VIEWS_CONTENT_BOTTOM_CENTER, IDR_VIEWS_CONTENT_BOTTOM_LEFT_CORNER,
            IDR_VIEWS_CONTENT_LEFT_SIDE,
        0
      };
