...
deps = {
  "src/breakpad/src":
    "http://google-breakpad.googlecode.com/svn/trunk/src@322",
  ...
  "src/third_party/WebKit":
    "/trunk/deps/third_party/WebKit@14055",
  ...
  "src/tools/gyp":
    "http://gyp.googlecode.com/svn/trunk@435",

  "src/v8":
    "http://v8.googlecode.com/svn/trunk@1735",
