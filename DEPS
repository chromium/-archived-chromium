vars = {
  ...
  "webkit_revision": "44252",
}


deps = {
  "src/breakpad/src":
    "http://google-breakpad.googlecode.com/svn/trunk/src@344",
  ...
  "src/tools/gyp":
    "http://gyp.googlecode.com/svn/trunk@506",
  ...
  "src/third_party/tcmalloc/tcmalloc":
    "http://google-perftools.googlecode.com/svn/trunk@73",
}
