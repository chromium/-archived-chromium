deps = {
  ...
  "src/third_party/WebKit":
    "/trunk/deps/third_party/WebKit@6360",
  ...
  "src/webkit/data/layout_tests/LayoutTests":
    "http://svn.webkit.org/repository/webkit/trunk/LayoutTests@38850",

  "src/third_party/WebKit/WebKit":
    "http://svn.webkit.org/repository/webkit/trunk/WebKit@38850",

  "src/third_party/WebKit/WebKitLibraries":
    "http://svn.webkit.org/repository/webkit/trunk/WebKitLibraries@38850",
}
